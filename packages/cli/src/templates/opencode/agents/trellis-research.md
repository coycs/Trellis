...
Run `trellis task current --source` → active task path. If no active task is set, ask the user where to write output; do NOT guess.
...
- `.trellis/workflow.md`, platform config (`.claude/`, `.cursor/`, `.opencode/`, etc.)
